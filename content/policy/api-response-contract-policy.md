...
- 공통 타입 산출물: `coupler-api/contracts/generated/apiContract.ts`, `coupler-mobile-app/src/api/generated/apiContract.ts`, `coupler-admin-web/src/api/generated/apiContract.ts`
...
- Mobile/Admin은 `ok`로 먼저 분기하고, 실패 세부 처리는 generated runtime contract와 [API 에러 계약 정책](api-error-contract-policy.md)을 따른다.
...
- 공통 response writer, generated contract, Mobile/Admin request boundary가 같은 envelope을 가리키는지 확인한다.
...
- [ ] Swagger/OpenAPI, generated contract, Mobile/Admin boundary, 정책 문서가 같은 envelope 기준을 가리키는가?
