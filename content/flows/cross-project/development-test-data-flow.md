...
| N:N 그룹미팅 | 저장·실효 행사·취소 진입 exhaustive set, `Toto`·`dummy-female` 승인 신청과 상태별 채팅 멤버십, 전날 13시 개방 및 시작 +24시간 종료의 1초 전·정각·1초 후, 신청·승인 마감 전 시각, 행사·이미지·상태 action·신청/승인·취소/퇴장·메시지·후기/신고의 인과 순서와 미래 row 0건, 실효·저장 종료·확정 후 취소 방의 기준 참여자·호스트·관리자 삭제 메시지·읽음 위치, 후기 완료 `LEFT` 무메시지 전이와 `APPROVED`·`LEFT` 미작성 분기, 신고 상태·미처리 filter·합성 대상 패널티의 Admin 목록 노출, 확정·종료 무료 프로필 조회 조건과 관련 저장·Key 차감 0건, 정원·고아 0건 |
