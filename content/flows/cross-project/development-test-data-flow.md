...
| N:N 그룹미팅 | 행사·취소 진입 exhaustive set, `Toto`·`dummy-female` 승인 신청과 상태별 채팅 멤버십, 전날 13시 개방 경계를 실제로 지난 활성 확정 방·종료·확정 후 취소 방의 두 기준 참여자·호스트·관리자 삭제 메시지, 신고 상태·미처리 filter·합성 대상 패널티의 Admin 목록 노출, 확정·종료 무료 프로필 조회 조건과 관련 저장·Key 차감 0건, 정원·고아 0건 |
