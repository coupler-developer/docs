...
```release-metadata
{
  ...
  "versionMapping": {
    ...
    "coupler-api": {
      "tag": "v2.5.1",
      "commit": "da236b23ba0c7ecad9b0881c1fedf38f636903b0"
    },
    "coupler-admin-web": {
      "tag": null,
      "commit": null
...
- `coupler-api`: 태그 `v2.5.1`, 커밋 `da236b23ba0c7ecad9b0881c1fedf38f636903b0`
...
- Scope별 Gate·smoke·artifact: API 후보 `da236b23`에서 `pnpm verify` 통과, 186 suites·1,641 tests 성공
