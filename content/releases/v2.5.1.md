...
```release-metadata
{
  ...
  "versionMapping": {
    ...
    "coupler-api": {
      "tag": "v2.5.1",
      "commit": "a67da8fa3d1c455806eb9144336fab1243f79338"
    },
    "coupler-admin-web": {
      "tag": null,
      "commit": null
...
- `coupler-api`: 태그 `v2.5.1`, 커밋 `a67da8fa3d1c455806eb9144336fab1243f79338`
...
- Scope별 Gate·smoke·artifact: API 후보 `a67da8fa`에서 표준 품질 게이트 통과, 187 suites·1,653 tests 성공
