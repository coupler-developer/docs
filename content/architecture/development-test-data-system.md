...
- 전날 오후 1시 개방 경계와 시작 +24시간 종료 경계 사이에 배치한 활성 확정 방, 종료 방, 확정 후 취소 방에서
  두 기준 참여자의 일반 채팅, 호스트 채팅, 관리자 삭제 채팅, 읽음 위치와 파생 개방 여부
- 프로필 열람 공개·비공개, 후기 성공·실패, 두 기준 참여자가 신고자인 대기·처리·기각 신고와 미처리 filter
