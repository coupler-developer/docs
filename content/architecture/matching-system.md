...
| `matching.reservation` | 매칭 후보 예약 | root | entity | history | 자동 매칭 후보와 실패 사유 | 내부 | 실행 결과 확인 기간 동안 보존 |
...
| `matching.reservation` | `policy` | references | `matching.reservation-policy` | N:1 | 실행 시점에 적용한 기준을 운영 로그로 추적 |
